import { Leaderboard } from "@/components/repricing/Leaderboard";
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-3">
        <div className="lg:col-span-2">
          <Card className="flex h-full items-center justify-center p-5 text-sm text-muted-foreground">
            Portfolio volume chart — coming soon
          </Card>
        </div>
        <Leaderboard data={portfolioData} />
      </div>
